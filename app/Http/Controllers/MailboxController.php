...
//                    ->where('parent_id', 0)
        ...
        } else if ($foldername == "Enviados" || $foldername == "Borradores") {
...
//        $folder = $mailbox->userFolder()->folder()->first();
    ...
    public function toggleImportant(Request $request)
    {
        ...
        return response()->json(['state' => 1, 'msg' => 'actualizado correctamente', 'updated' => $updated], 200);
    }
    ...
    public function trash(Request $request)
    {
        ...
        $trashFolder = MailboxFolder::where('title', 'Papelera')->first();
    ...
    public function postReply(Request $request, $id)
    {
        ...
        return redirect('admin/mailbox-show/' . $id)->with('flash_message', 'Respuesta enviada');
    }
    ...
    public function send($id)
    {
        ...
        $mailbox_user_folder->folder_id = MailboxFolder::where("title", "Enviados")->first()->id;
        ...
        foreach ($receiver_ids as $receiver_id) {
            ...
            $mailbox_user_folder->folder_id = MailboxFolder::where("title", "Bandeja")->first()->id;
    ...
    private function save($submit, $receiver_ids, $mailbox)
    {
        ...
        if($submit == 2) {
            $mailbox_user_folder->folder_id = MailboxFolder::where("title", "Borradores")->first()->id;
        } else {
            $mailbox_user_folder->folder_id = MailboxFolder::where("title", "Enviados")->first()->id;
        }
