...
class DocumentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Documento añadido');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Documento actualizado');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Documento eliminado');
    }
    ...
    public function postAssignDocument(Request $request, $id)
    {
        ...
        return redirect('admin/documents')->with('flash_message', 'Documento asignado');
    }
