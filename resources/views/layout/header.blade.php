@inject('companyName', 'App\Services\Name')
<header class="main-header">
    <!-- Logo -->
    <a href="{{ url('/admin') }}" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini">Track</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Track</b>@if(\Auth::user()->company_id == 2) {{'CRM'}} @else {{$companyName->get()}} @endif</span>
    </a>
                ...
                @if(user_can("show_email_notifications"))
                    <li class="dropdown messages-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @else
                                <li class="header">Tienes {{ count(getUnreadMessages()) }} mensajes</li>
                                <li>
                                ...
                                <li class="footer"><a href="{{ url('admin/mailbox/Inbox') }}">Ver todos los mensajes</a></li>
                            @endif
                        </ul>
                    </li>
            @endif
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{url('admin/my-profile/')}}" class="btn btn-default btn-flat">Perfil</a>
                            </div>
