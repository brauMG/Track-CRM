                            ...
                            <table class="table">
                                ...
                                @foreach($documents as $item)
                                    <tr>
                                        ...
                                        <td>{!! $item->status == 1?"<i class='label label-success'>Activo</i>":"<i class='label label-danger'>Inactivo</i>" !!}</td>
                                        ...
                                        <td>
                                            ...
                                            @if(user_can('assign_document'))
                                                <a href="{{ url('/admin/documents/' . $item->id . '/assign') }}" title="Assign document"><button class="btn btn-primary btn-sm"><i class="fa fa-envelope-o" aria-hidden="true"></i> Asignar</button></a>
                                            @endif
