            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/campaigns/update/' . $campaign->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}

                            @include ('pages.campaigns.form', ['formMode' => 'edit'])
