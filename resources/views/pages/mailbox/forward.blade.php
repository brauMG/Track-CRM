...
@section('title', ' | Bandeja | Mensaje de seguimiento')
...
@section('content')
    ...
    <section class="content with-sponsor">
        <div class="row">
            <div class="col-md-3">
                <a href="{{ url('admin/mailbox') }}" class="btn btn-primary btn-block margin-bottom">Volver a la bandeja de inicio</a>
                ...
                <form method="post" action="{{ url('admin/mailbox-forward/' . $mailbox->id) }}" enctype="multipart/form-data">
                    ...
                    <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="subject" placeholder="Asunto:" value="{{ old("subject")!=null?old("subject"):$mailbox->subject }}">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <button type="submit" class="btn btn-default"><i class="fa fa-reply"></i> Enviar</button>
                            </div>
                        </div>
                        <!-- /.box-footer -->
                    </div>
